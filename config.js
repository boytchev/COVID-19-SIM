...
export const GROUND_SIZE = 150; 				// in meters
...
export const DEBUG_TIME_SPEED = timeMs(0,0,20)/1000;	// time ellapsed for 1 second
...
export const INFECTION_TOTAL_MS = new Range( timeMs(0), timeMs(10) ); // 40 min - 10 hours
