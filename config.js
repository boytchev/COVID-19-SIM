...
export const DEBUG_AUTOROTATE = param('dar', 0);
export const DEBUG_ALLOW_UNDERGROUND = param('dau', false);
...
export const ADULT_WAKE_UP_TIME_MS = param2('awu',new Range( timeMs(5,30), timeMs(7) ));
...
export const ADULT_LEAVE_HOME_TIME_MS = param2('alh',new Range( timeMs(6), timeMs(8) ));
export const ADULT_LEAVE_WORK_TIME_MS = param2('alw',new Range( timeMs(17), timeMs(20) ));
export const AGENT_PAUSE_TIME_AT_HOME_MS = param2('apth',new Range( timeMs(0,0), timeMs(0,10) ));
export const AGENT_PAUSE_TIME_AT_WORK_MS = param2('aphw',new Range( timeMs(0,0), timeMs(0,20) ));
