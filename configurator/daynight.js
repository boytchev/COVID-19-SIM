...
CFG.addHeader(
	...
	'daynight,morning,light,house,apartment,office', {internal:true} );

CFG.addHeader(
	3, 'Houses', '', '',
	'daynight,morning,light,house', {internal:true} );
...
CFG.addHeader(
	3, 'Apartments', '', '',
	'daynight,morning,light,apartment', {internal:true} );
...
CFG.addHeader(
	3, 'Offices', '', '',
	'daynight,morning,light,office', {internal:true} );
...
CFG.addHeader(
	...
	'daynight,evening,light,house,apartment,office', {internal:true} );

CFG.addHeader(
	3, 'Houses', '', '',
	'daynight,evening,light,house', {internal:true} );
...
CFG.addHeader(
	3, 'Apartments', '', '',
	'daynight,evening,light,apartment', {internal:true} );
...
CFG.addHeader(
	3, 'Offices', '', '',
	'daynight,evening,light,office', {internal:true} );
