...
import {timeMs, Size, Range} from './core.module.js';

export const VR = false;

export const GROUND_SIZE = 220; 				// in meters
...
export const DEBUG_BUILDINGS_OPACITY = 2/4;	// for buildings and trees
export const DEBUG_BLOCKS_OPACITY = 4/4;		// for blocks
export const DEBUG_NAVMESH_OPACITY = 4/4;		// for navmesh blocks
...
export const MAX_APARTMENT_BUILDING_FLOORS = 50;				// maximal number of floors in an apartment building
...
export const TREE_COMPLEXITY = 3; // 12*n^2 triangles, 2=48, 3=108, 4=192, 5=300
...
export const START_TIME = timeMs(6);			// start time
...
export const INFECTION_TOTAL_MS = new Range( timeMs(0,4), timeMs(0,20) ); // 10-60 min in ms
...
export const INFECTION_STRENGTH = 0.2; // factor of how fast is the infection
export const IMMUNE_STRENGTH = new Range( 100, 200 );
export const IMMUNE_RECOVERY_FACTOR = 0.01; // recovery of immune per second
export const IMMUNE_CURE_FACTOR = new Range( 1.0, 1.2 ); // increase of immunity after cure
export const PERCENTAGE_INITIAL_INFECTED = 0.05; // 0.01=1%
