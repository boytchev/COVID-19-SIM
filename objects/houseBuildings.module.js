...
import {HouseSidewalks, HouseSidewalk, HouseSidewalkPath} from './houseSidewalks.module.js';
import {blocks, navmesh, textures, scene} from '../main.module.js';
import {round, Pos, Size, Zone} from '../core.module.js';
import {pick} from '../coreNav.module.js';
import {SIDEWALK_WIDTH, HOUSE_BOUNDING_RADIUS, FLOOR_HEIGHT, DEBUG_HIDE_ROOFS, SHADOWS, NO_SHADOWS, DEBUG_ALL_WHITE, DEBUG_BUILDINGS_OPACITY} from '../config.module.js';
