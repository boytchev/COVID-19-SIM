...
import {textures, blocks, scene, navmesh} from '../main.module.js';
import {MAX_FLOORS, SIDEWALK_WIDTH, OFFICE_TEXTURE_SCALE_U, FLOOR_HEIGHT, OFFICE_DOOR_WIDTH, OFFICE_DOOR_DISTANCE, OFFICE_ROOM_SIZE, BUILDING_TEXTURE_SCALE, DEBUG_BUILDINGS_OPACITY, OFFICE_CORRIDOR_WIDTH, OFFICE_ROOM_COUNT, SHADOWS, NO_SHADOWS} from '../config.module.js';
import {Size, round, TOP, RIGHT, LEFT, BOTTOM, Pos} from '../core.module.js';
...
import {OfficeDoor} from './officeDoors.module.js';
import {Elevator} from './elevators.module.js';
import {Room} from './rooms.module.js';
